...
class SettingFavoriteVC: UIViewController, Localizable {
    ...
    private func addSubTableView() {
        ...
        tableView.register(SettingFavoriteCell.self, forCellReuseIdentifier: identifier)
    ...
    private func setupNavigationBar() {
        ...
        let navigationItem = UINavigationItem(title: localize(for: "Favorite"))
...
extension SettingFavoriteVC: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as? SettingFavoriteCell else {
...
extension SettingFavoriteVC: NSFetchedResultsControllerDelegate {
